...
CREATE UNIQUE INDEX IF NOT EXISTS user_info_email_index ON user_info(email);
...
ALTER TABLE attachment DROP CONSTRAINT IF EXISTS attachment_extension_constraint;
